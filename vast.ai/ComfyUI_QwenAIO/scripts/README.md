...
- **RunPodでComfyUI環境を起動**
    ...
    - 起動後、ターミナルで /workspace/ComfyUI/models/checkpoints に移動
...
```bash
rm ComfyUI/models/checkpoints/*
pip install -U huggingface_hub[cli] hf_transfer
hf download Phr00t/Qwen-Image-Edit-Rapid-AIO v19/Qwen-Rapid-AIO-NSFW-v19.safetensors --local-dir /workspace/ComfyUI/models/checkpoints/
...
# スクリプトの使い方
- 同フォルダ内のファイルを `/workspace/ComfyUI/scripts/` に配置
- 実行例

```bash
python3 /workspace/ComfyUI/scripts/batch_api_qwen-edit.py
